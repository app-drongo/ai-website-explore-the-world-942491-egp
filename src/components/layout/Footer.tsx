...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Discover breathtaking destinations and create unforgettable memories with our curated travel experiences. Join thousands of adventurers who trust us to make their dream trips a reality.',
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Beach Escapes', href: '/beaches', editableId: 'link-footer-beaches' },
        { name: 'Mountain Treks', href: '/mountains', editableId: 'link-footer-mountains' },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Travel Stories', href: '/stories', editableId: 'link-footer-stories' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Safety Guidelines', href: '/safety', editableId: 'link-footer-safety' },
      ],
    },
  ];
