...
const DEFAULT_HERO = {
  badge: 'New: Exclusive 2024 Destinations',
  title: 'Discover breathtaking adventures with',
  titleHighlight: 'Explore the World',
  description:
    'From the romantic streets of Paris to the ancient pyramids of Egypt. Create unforgettable memories with our expertly curated travel experiences.',
  features: [
    'Expert local guides',
  ...
  imageAlt: 'Travelers exploring ancient architecture',
  statsLabel1: 'Happy Travelers',
  statsValue1: '50,000+',
  statsLabel2: 'Destinations',
  statsValue2: '120+ Cities',
} as const;
